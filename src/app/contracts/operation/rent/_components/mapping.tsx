...
export function mapContract(
  ...
  return {
    ...
    // Prefer the API branch names; fall back to the office name when unscoped.
    branch: contract.branchNameEn || contract.branchNameAr || 'Sigma Recruitment Office',
    branchAr: contract.branchNameAr || contract.branchNameEn || 'سيجما الكفاءات للاستقدام',
    duration: contract.duration ?? null,
    durationNameAr: contract.durationNameAr || '',
    durationNameEn: contract.durationNameEn || '',
    workerPhotoUrl: contract.workerPhotoUrl || '',
    daysRemaining,
